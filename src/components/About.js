    ...
    return (
        <Box>
            ...
            <ThemeContainer theme={theme}>
                ...
                <IntroTypography>Yet by autumn of the same year Organic Films was in freefall. One of Organic Films top directors was ejected from the Mission Impossible set after a dispute over a false moustache. Star performer Adam Brody was locked in an expensive legal battle with Kraft Foods. But most damagingly of all was the attempt to pivot Organic Films into the world of music videos.</IntroTypography>
